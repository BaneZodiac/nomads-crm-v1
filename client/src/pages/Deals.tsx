              ...
              {grouped[stage]?.map(deal => (
                ...
                >
                  <div className="flex items-start justify-between mb-1">
                    ...
                    <button onClick={e => { e.stopPropagation(); setMenuOpen(menuOpen === deal.id ? null : deal.id) }} className="p-0.5 hover:bg-gray-100 rounded opacity-0 group-hover:opacity-100 transition-opacity">
